  ...
  return (
    <div className="flex items-center justify-between gap-10 w-full">
      <Button
        ...
        } bg-[#433d49] hover:bg-[#433d49] border-[#50464b] w-[94px]`}
        onClick={() => setSelectedCoin("head")}
      >
        <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#fbff29] to-[#f92d00] text-[23px] font-semibold">
          HEAD
        </span>
      </Button>
